    ...
    public function setProvider($providerClass): Sender
    {
        ...
        try {
            ...
            if ($providerClass === null) {
                throw new RenderException("Provider is empty. Be sure, you have run 'php artisan vendor:publish --provider=Xenon\LaravelBDSms\LaravelBDSmsServiceProvider' and also you have set provider using setProvider(Provider::class) method. Set default provider in config/sms.php if you use \Xenon\LaravelBDSms\Facades\SMS::shoot() facade");
            }
